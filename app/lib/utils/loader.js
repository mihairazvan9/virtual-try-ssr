...
function loader (canvas_id) {
  ...
  texture_loader.load(new URL('@/assets/brown_photostudio_02_1k.webp', import.meta.url).href, (texture) => {
    hdr = texture
  })
  ...
  // // Set the decoder path - use relative path from public directory
  ...
  // loader.load(new URL('@/assets/glasses1.glb', import.meta.url).href, (gltfScene) => {
